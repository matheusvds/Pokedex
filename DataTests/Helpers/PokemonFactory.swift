...
func makePokemonListModel() -> ReferenceList {
    return ReferenceList(count: 0, next: "", previous: "", results: [makePokemonModel()])
}
func makeEmptyPokemonListModel() -> ReferenceList {
    return ReferenceList(count: 0, next: "", previous: "", results: [])
}

func makePokemonModel() -> Reference {
    return Reference(name: "pok1", url: "any.com")
}

func makePokemons() -> [Pokemon] {
    return [pokemon].compactMap { $0 }
}
